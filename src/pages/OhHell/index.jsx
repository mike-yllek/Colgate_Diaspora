...
const RULES = [
  ...
  },
  {
    ...
    body: 'The game runs in rounds of decreasing then increasing hand sizes. Start at the maximum (deck ÷ players, up to 10 cards), count down to 1, then back up. The full game is a V-shape — total rounds = 2 × max − 1.',
  },
  {
    title: 'Bidding',
    body: 'After dealing, players bid in turn. The dealer bids last. The total of all bids cannot equal the number of tricks available — the dealer must pick a bid that keeps the totals off. This constraint is the great tension of Oh Hell.',
  },
  {
    title: 'Trump Suit',
...
export default function OhHellLobby() {
  ...
  const handleCreate = () => {
    const name = createName.trim() || 'Guest'
    const room = createRoom.trim() || Math.random().toString(36).slice(2, 8)
    navigate(`/oh-hell/${room.toLowerCase().replace(/\s+/g, '-')}`, {
      state: { playerName: name, playerCount, isHost: true },
    })
  }
  ...
  const handleJoin = (e) => {
    ...
    navigate(`/oh-hell/${joinCode.trim().toLowerCase()}`, {
      state: { playerName: joinName.trim() || 'Guest' },
    })
  }
          ...
          >
              ...
              {revealPhase >= 2 && (
                <motion.h1
                  ...
                  style={{
                    ...
                    color: 'var(--gold)',
                    textShadow: '0 0 50px rgba(200,168,75,0.6)',
                    textAlign: 'center',
                    margin: 0,
                  }}
                >
            ...
            <AnimatePresence>
              {revealPhase >= 3 && (
                ...
                >
                  Oh Hell! — The Preferred Card Game of the Colgate Diaspora
                </motion.p>
              )}
            </AnimatePresence>
          </motion.div>
          ...
          >
            ...
            <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
              <div style={{
                ...
                filter: 'drop-shadow(0 0 22px rgba(200,168,75,0.85))',
                userSelect: 'none',
              }}>
                ⚡
              </div>
              ...
              <div style={{
                ...
                >
                  {[3, 4, 5, 6, 7, 8, 9, 10].map(n => (
                    <option key={n} value={n} style={{ background: '#0D0508' }}>
                      {n} Players
                    </option>
                  ))}
                </select>
                ...
                <button
                  ...
                  onMouseEnter={e => {
                    ...
                    e.currentTarget.style.boxShadow = '0 0 20px rgba(200,168,75,0.22)'
                  }}
                  onMouseLeave={e => {
                        ...
                        <div key={i} style={{
                          ...
                          >
                            ...
                            <span style={{
                              ...
                              opacity: 0.4,
                              fontSize: '0.75rem',
                              transform: openRule === i ? 'rotate(180deg)' : 'none',
